                            ...
                            <tr>
                                <td align="center" class="" style="width: 600px;">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="" style="padding: 20px 0; text-align: center; ;">
                                                                    <img alt="" class=" " src="{{ asset('images/seamco_letter_head@2x.png') }}" style="border: 0; height: auto; max-width: 100%; vertical-align: middle; ;" width="500">
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                            ...
                                                            <tr>
                                                                <td class="" style="padding: 20px 0; text-align: left; color: #474747; font-family: sans-serif;">
                                                                    ...
                                                                    <p style="margin: 20px 0; font-size: 14px; mso-line-height-rule: exactly; line-height: 24px; margin: 30px 0;">
                                                                            Have questions about the SEAMCO? We’d love to help! Just email us @ <a href="mailto:info@seamco.org?subject=Inquiry" target="_blank">info@seamco.org</a>
                                                                    </p>
                                                                    <p style="margin: 20px 0; font-size: 14px; mso-line-height-rule: exactly; line-height: 24px; margin: 30px 0; margin: 45px 0 0;">
                                                                        Best Regards, <br> 
                                                                    <span style="font-weight: bold;">SEAMCO Team</span>
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                    ...
                                    <table cellpadding="0" cellspacing="0" dir="ltr" style="border: 0; width: 100%;">
                                        <tbody>
                                            <tr>
                                                <td style="padding: 20px 0; text-align: center; color: #8f8f8f; font-family: sans-serif; font-size: 12px; mso-line-height-rule: exactly; line-height: 20px;">
                                                    <p style="margin: 20px 0; margin: 0; text-align: center;">
                                                        SEAFARERS MIGHTY CREDIT COOPERATIVE @ {{ now()->year }}
                                                    </p>
                                                </td>
                                            </tr>
                                        </tbody>
